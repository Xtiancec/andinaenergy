...
<!-- FontAwesome (Ya está incluido en el header, no es necesario repetirlo) -->
<!-- Dropify -->
...
<?php
// Variable para almacenar scripts específicos de cada página
